OUTPUT_DIR="work_dirs/final_models/cascade_mask_rcnn_vitdet_1B_bs64_1280_attn_pt320ko365_lr2.5e-5"
...
python tools/lazyconfig_train_net.py --num-gpus 8 \
  ...
  --eval-only \
  "train.init_checkpoint=${OUTPUT_DIR}/model_0044999_modelonly.pth" \
