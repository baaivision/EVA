...
model.backbone.net.img_size = 1536  # 1024
model.backbone.square_pad = 1536  # 1024
...
model.backbone.net.window_block_indexes = (
    ...
    # list(range(0, 9)) + list(range(10, 19)) + list(range(20, 29)) + list(range(30, 39))
    # list(range(0, 13)) + list(range(14, 26)) + list(range(27, 39))
    # list(range(0, 19)) + list(range(20, 39))
    list(range(0, 40))
)
