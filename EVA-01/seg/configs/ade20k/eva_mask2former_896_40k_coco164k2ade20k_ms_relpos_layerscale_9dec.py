...
load_from = '/path/to/eva_sem_seg_mask2former_cocostuff_relpos_layerscale_9dec_53p2.pth'
model = dict(
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(3584, 896),
        img_ratios=[512./896., 640./896., 768./896., 896./896., 1024./896., 1152./896., 1280./896.],        # 62.3
        flip=True,
        transforms=[
