...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='eva_g_patch14', type=str, metavar='MODEL',
    ...
    parser.add_argument('--ema_eval', action='store_true', help='eval ema ckpt')
...
def main(args, ds_init):
    ...
    if args.eval:
        if args.real_labels:
            ...
            evaluate_real(data_loader_val, model, device, real_labels)
        else:
